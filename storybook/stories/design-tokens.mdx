...
export const variables = [
  {
    name: "--primary-color",
    description:
      "Sets the primary color for the widget.",
    defaultValue: "#574ae2",
  },
  {
    name: "--secondary-color",
    description:
      "Sets the secondary color for the widget.",
    defaultValue: "#ffffff",
  },
  {
    name: "--color-secondary-opposite",
    description:
      "Sets the secondary opposite color for the widget.",
    defaultValue: "#000000",
  },
  {
    name: "--color-danger",
    description:
      "Sets the danger color for the widget.",
    defaultValue: "#C6423F",
  },
  {
    name: "--font-family",
