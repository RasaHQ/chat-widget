import { Component, Event, EventEmitter, Fragment, Host, Listen, Prop, State, h } from '@stencil/core/internal';
import { MESSAGE_TYPES, Message, Rasa } from '@rasa-widget/core';
