...
describe("MessageParsers", () => {
  ...
  it("accordion message correctly parsed", () => {
    ...
    expect(MessageParsers.accordion(accordionResponse, sender)).toEqual(
      expected
    );
  });
  ...
  it("quick reply message correctly parsed", () => {
    ...
    expect(MessageParsers.quickReply(quickReplyResponse, sender)).toEqual(
      expected
    );
  });
  ...
  it("file download message correctly parsed", () => {
    ...
    expect(MessageParsers.fileDownload(fileDownloadResponse, sender)).toEqual(
      expected
    );
  });
